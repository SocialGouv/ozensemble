        ...
        <ScrollView>
          <TopContainer>
            ...
            <SubTitle>
              ...
              <TextStyled color="#191919">
                La ligne verte représente le seuil de l’OMS. Elle est à 2 verres par jour pour une
                femme et 3 verres par jour pour un homme.{'\n\n'}
              </TextStyled>
            </SubTitle>
            <SubTitle>
              <TextStyled color="#191919">
            ...
            <SubTitle>
              <TextStyled color="#191919">
                Lorsque vous saisisez une consommation, l’application convertit automatiquement en
                unité d’alcool.
                {'\n\n'}
              </TextStyled>
            </SubTitle>
            <SubTitle>
              <TextStyled color="#191919">
                Compter ses consommations est un pas essentiel pour prendre conscience de ce que
                l’on consomme.{'\n\n'}
              </TextStyled>
            </SubTitle>
          </TopContainer>
