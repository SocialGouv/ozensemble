...
const NewDrinkForm = ({ isNew, code, visible, onClose, onValidate, ...init }) => {
  ...
  const handleValidate = () => {
    ...
    onValidate(
      name,
      formatDecimalNumber(volume),
      formatDecimalNumber(degrees),
      newDrinkKey,
      quantity
    );
    if (code) {
  ...
  return (
    <>
      <Modal visible={visible} transparent animationType="slide" onRequestClose={onClose}>
        ...
        <DrinksQuantityExample
          visible={showHelp}
          onClose={() => onShowHelp(false)}
          onPress={setVolume}
        />
      </Modal>
    </>
  ...
  <Modal visible={visible} transparent animationType="slide" onRequestClose={onClose}>
    <SafeAreaViewStyled>
      ...
      <ModalContent>
        ...
        <Explanation last>
          Cliquez sur un contenant pour remplir automatiquement le champ
        </Explanation>
        <FormContainer>
