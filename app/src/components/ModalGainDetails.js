...
const ModalGainDetails = ({ weekExpenses, weekExpenses, isConso, firstDay, lastDay, onClose }) => {
      ...
      <View className="bg-white rounded-xl">
        ...
        <View className="mb-4 p-2">
          ...
          <View className="flex flex-row justify-around mt-8">
            <View className="rounded-md bg-[#F5F6FA]">
              <Text className="text-[#4030A5] font-semibold text-center text-xs">Estimation initiale</Text>
              <View className={'flex flex-row justify-center'}>
                <Text className="text-center font-bold mt-1 text-xl">{Math.round(content?.estimationExpenses)}</Text>
