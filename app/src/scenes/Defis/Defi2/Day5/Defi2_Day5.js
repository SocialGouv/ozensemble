...
const TipsAngrySmiley = () => (
  <TipsContainer>
    ...
    <TextStyled>
      ...
      5/ J'apprends à<TextStyled bold> reconnaître les signes de colère</TextStyled> pour mieux les contrôler et
...
const TipsSadSmiley = () => (
  <TipsContainer>
    ...
    <TextStyled>
      ...
      film, sieste, relaxation…), {'\n\n\n'}4/ J'<TextStyled bold>appelle un proche</TextStyled> pour être
      réconforté(e), {'\n\n\n'}5/ Je<TextStyled bold> ne remets plus au lendemain</TextStyled> des tâches et je m'occupe
      l'esprit (rangement, ménage, administratif…)
    </TextStyled>
  </TipsContainer>
);
...
const TipsIllSmiley = () => (
  <TipsContainer>
    <H1>Les conseils d'Oz Ensemble</H1>
    <TextStyled>
      {'\n'}Désormais, quand la situation se présente, je teste ces stratégies : {'\n\n\n'}1/ J'identifie ma douleur
      (car la connaître favorise sa maîtrise) et j'en <TextStyled bold>parle à un professionnel,</TextStyled> {'\n\n\n'}
