...
const Defi2_Day5_Navigator = ({ navigation, route }) => {
  ...
  return (
    <Defi2Day5Stack.Navigator headerMode="none" initialRouteName={'DEFI2_DAY6_ONBOARDING'}>
      <Defi2Day5Stack.Screen name="DEFI2_DAY6_ONBOARDING" component={Defi2_Day5_OnBoarding} />
      <Defi2Day5Stack.Screen name="DEFI2_DAY6" component={Defi2_Day5} />
