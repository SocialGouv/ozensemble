  ...
  return (
    <WrapperContainer title="Savoir dire Non" onPressBackButton={navigation.goBack}>
      ...
      <ElementDayDefi
        content={
          <TextStyled>
            Si initialement, il peut être commode de piocher dans nos “trucs et astuces”, plus le temps va passer, plus
            vous allez vous sentir confiant(e) dans votre décision de réduction pour{' '}
