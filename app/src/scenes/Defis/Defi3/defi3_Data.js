...
export const defi3_Data = [
  {
    actionType: 'content',
    title: 'J1',
    tagLine: "L'alcool en quelques chiffres",
    description: (
      <>
        Comprendre le rôle et la place de l’alcool dans mon environnement, c’est aussi{' '}
        <TextStyled bold>connaître les derniers chiffres.</TextStyled>
      </>
    ),
    descriptionDone: (
      <>
