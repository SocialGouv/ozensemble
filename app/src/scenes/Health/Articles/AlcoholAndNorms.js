    ...
    <Background color="#39cec0" withSwiperContainer>
      <NavigationWrapper
        ...
        <TopContainer>
          ...
          <Spacer size={20} />
          <P>
            Pour les autorités sanitaires françaises, il n'y a <Bold>pas de consommation d'alcool sans risque</Bold>,
            mais des consommations à risque plus ou moins élevé.{'\n'}
          ...
          <P>
            ...
            lieux et les activités à risque de consommation excessive d'alcool, {'\n   • '}de s'assurer d'être entouré
            de personnes de confiance et de pouvoir rentrer chez soi en toute sécurité après avoir consommé de l'alcool.
          </P>
          ...
          <P>
            ...
            <Bold> consommation répétée</Bold> de boissons alcoolisées peut prendre différentes formes selon le rythme
            de consommation et la quantité d'alcool ingérée.{'\n'} On distingue divers degrés de sévérité qui vont de
          ...
          <P>
            ...
            hommes contre 5 % de la population féminine. La consommation excessive d'alcool serait responsable, selon
            les sources, de 33 000 à 49 000 décès par an en France.
          </P>
          <P>
            ...
            même lorsqu'elle entraîne des conséquences manifestement problématiques. Tout d'abord, le buveur développe
            une tolérance. Il doit <Bold>boire des quantités toujours plus importantes</Bold> d'alcool pour obtenir les
            effets recherchés.
          </P>
          <P>
          ...
          <P>
            ...
            essentiellement due à une baisse de la consommation de vin. Mais ces chiffres optimistes ne doivent pas
            cacher la réalité :
            <Bold>
              {' '}
          ...
          <P>
            La consommation de boissons alcoolisées <Bold>a fortement baissé depuis 1970</Bold> : nous sommes passés de
            22 litres d'alcool pur par an et par personne de plus de 15 ans (soit 5 verres par jour), à environ
          ...
          <P>
            ...
            {'\n'} Majoritairement, 58% boivent du <Bold>vin</Bold> (en baisse sensible), 22% des{' '}
            <Bold>spiritueux</Bold> (en augmentation) et 17,5% de la <Bold>bière</Bold> (stable depuis des années).
          </P>
          <P>
            <Bold>Qui sont les consommateurs quotidiens ?</Bold> 20% des hommes et 7 % des femmes de 12 à 75 ans
            déclarent consommer une boisson alcoolisée tous les jours, et pour la tranche d'âge 65-75 ans, ce taux
            montent à 56 % des hommes et 23 % des femmes.
          </P>
          <P>
            Dans l'Union européenne, la France se place en 15e position en terme de consommation d'alcool par habitant,
            un peu au dessus de la moyenne. Les pays d'Europe centrale et de l'Est restent les plus gros consommateurs
          ...
          <P>
            ...
            particulièrement dangereuse, car elle peut être responsable d'intoxication aiguë (déliriums) pouvant
            entraîner le décès par arrêt cardiaque.
          </P>
          <P>
