        ...
        <NavigationWrapper title={'Le saviez-vous ?'} timeReading={2}>
          <TopContainer>
            ...
            <P>
              ...
              boisson alcoolisée que vous consommez (vin, bière ou alcool fort). (illustration à récupérer dans Figma
              sur le frame : Bottom sheet Compter verre d'alcool )
            </P>
            <OneDoseAlcoolExplanation marginOffset={defaultPaddingFontScale()} />
            <P>
            ...
            <P>
              {'    - '}L'alcool peut contribuer à l'<Bold>apparition de problèmes de santé mentale</Bold>, notamment
              chez les personnes ayant une prédisposition génétique ou une sensibilité aux effets de l'alcool
            </P>
            <P>
            ...
            <P>
              {'    - '}L'alcool peut pousser à des <Bold>comportements à risques</Bold> (comme des rapports sexuels
