        ...
        <NavigationWrapper title={"Pour m'aider à réduire"} timeReading={3}>
          <TopContainer>
            ...
            <P>
              ...
              À chaque fois que vous consommez de l'alcool, prenez le réflexe de <Bold>boire un verre d'eau.</Bold>
            </P>
            ...
            <P>
              Si vous buvez toujours un verre après le travail, ajoutez à cela une autre habitude plaisante au moins
              deux jours par semaine. Par exemple, vous pouvez vous accorder un plaisir culinaire, faire une promenade,
              prendre une bonne douche, etc.
            </P>
            <P>
              <Bold>À domicile </Bold>
            </P>
            <P>
              Si vous buvez principalement à domicile, ne faites plus de grande réserve d'alcool et/ou faites en sorte
              de ne pas en avoir du tout chez vous à intervalles réguliers.
            </P>
            <P>
            ...
            <P>
              Ne buvez pas seul, il est trop facile de <Bold>commencer à boire en quantité excessive</Bold>.
              Imposez-vous cette règle : ne boire qu'entre amis, pour le plaisir.{'\n'} « Après le boulot, je bois
              toujours un verre de vin blanc »... <Bold>ces routines de consommation d'alcool</Bold> sont de véritables
              pièges. Essayez de les reconnaître et de trouver une alternative. Il peut s'agir d'un thé, d'un smoothie,
              ou d'une simple promenade.
            </P>
            <P>
              N'utilisez pas l'alcool pour étancher votre soif, mais uniquement <Bold>pour le plaisir</Bold>.
            </P>
            <P>
              Procurez-vous des verres de taille “bistrot” : il existe des verres à dégustation pour le vin, mais une
              fois remplis ils peuvent en réalité contenir jusqu'à 5 verres de 10 cl.
            </P>
            <Spacer size={20} />
            ...
            <P>
              ...
              au spa, ou pour faire des économies ? {'\n'}
              {'    - '}Vous pouvez vous engager à ne dépenser que la moitié de ce montant, et profiter de cet argent
            ...
            <Spacer size={20} />
            <P>
              Prévoyez toujours des <Bold>boissons non alcoolisées lors d'une fête</Bold> ou lors de vos courses en cas
              de visite.
            </P>
            <P>
              Si vous sortez à plusieurs, mettez-vous d'accord auparavant sur celui ou celle qui restera sobre et
              ramènera les autres en voiture. Ou organisez un retour en taxi.
            </P>
            <P>
            ...
            <P>
              ...
              possibilités incluent des restaurants, des salons de thé, des marchands de yaourt glacé, ou encore des
            ...
            <P>
              ...
              boissons rafraîchissantes qui ne contiennent pas d'alcool (thé glacé, eau fruitée, virgin mojito, punch
