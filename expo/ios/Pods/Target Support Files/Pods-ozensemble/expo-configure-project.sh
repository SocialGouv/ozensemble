...
with_node \
  ...
  --target "/Users/arnaudambroselli/Pro/2020-01-027_Selego_Addicto_OzEnsemble/oz_ensemble/expo/ios/Pods/Target Support Files/Pods-ozensemble/ExpoModulesProvider.swift" \
  --platform "apple" \
  --packages "expo-application" "expo-asset" "expo-constants" "expo-file-system" "expo-font" "expo-keep-awake" "expo-system-ui" "expo-web-browser"
