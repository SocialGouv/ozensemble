      ...
      <Background color="#f9f9f9">
        <WrapperContainer
          ...
          <Text className="text-start text-[#DE285E] font-bold text-base">
            Sachez qu’un moment de craving n’est pas éternel, et dure généralement entre 5 et 20
            minutes.
          </Text>
          <View className="flex flex-col ">
            <Text className="text-start text-black text-base font-semibold">
              Oz vous propose divers conseils et activités afin de vous accompagner dans ces moments
              délicats.{" "}
            </Text>
          </View>
          ...
          <Text className="text-start text-black text-base font-semibold">
            Pour commencer, nous vous proposons de définir une stratégie à mettre en place afin de
            surmonter ce craving.{" "}
          </Text>
          <Text className="text-start text-black text-base font-semibold">
