  ...
  return (
    <Background color="#39cec0" withSwiperContainer>
      <CravingStack.Navigator
        ...
        initialRouteName="CRAVING_INDEX"
      >
        ...
        <CravingStack.Screen
          name="ALCOOL_WITHDRAWAL_TREATMENT"
          component={AlcoolWithdrawalTreatment}
        />
        <CravingStack.Screen name="TO_SAY_NO" component={ToSayNo} />
        <CravingStack.Screen
          name="CRAVING_TREATMENT"
          component={CravingsTreatment}
        />
        <CravingStack.Screen
          name="ALCOHOL_AND_NORMS"
          component={AlcoholAndNorms}
        />
        <CravingStack.Screen
          name="ALCOOL_WITHDRAWAL_BENEFITS"
          component={AlcoolWithdrawalBenefits}
        />
        <CravingStack.Screen
          name="ALCOHOL_ADDICTION"
          component={AlcoholAddiction}
        />
        <CravingStack.Screen
          name="ALCOHOL_AND_CALORIES"
          component={AlcoholAndCalories}
        />
        <CravingStack.Screen
          name="TO_HELP_ME_REDUCE"
          component={ToHelpMeReduce}
        />
        <CravingStack.Screen name="DID_YOU_KNOW" component={DidYouKnow} />
        <CravingStack.Screen
          name="ALCOHOL_AND_MOTIVATION"
          component={AlcoholAndMotivation}
        />
        <CravingStack.Screen
          name="ALCOHOL_AND_HEALTH_RISKS"
          component={AlcoholAndHealthRisks}
        />
        <CravingStack.Screen
          name="ALCOHOL_AND_DEPENDENCY"
          component={AlcoholAndDependency}
        />
