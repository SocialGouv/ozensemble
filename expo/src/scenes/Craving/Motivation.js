...
const motivations = [
  ...
  "La patience, la persévérance et la constance sont 3 éléments clés de votre réussite. Ne les perdez jamais de vue, car ils vous aideront à chaque moment difficile. \n\n Il n’y a aucune raison pour laquelle vous n’y arriverez pas !",
        ...
        <View className="h-full w-full" contentContainerStyle={{ height: "100%" }}>
          ...
          <View className="items-center h-full justify-between">
            ...
            <H1
              ...
              className="mb-10  text-black text-center font-semibold text-2xl px-8">
              {currentMotivation}
            </H1>
