  ...
  return (
    <WrapperContainer onPressBackButton={navigation.goBack} title="Comprendre les normes">
      <ElementDayDefi
        content={
          <TextStyled>
            Selon l'OMS (Organisation Mondiale de la Santé), l'alcoolodépendance est avérée lorsque
            la consommation de boissons alcoolisées devient{" "}
            <TextStyled bold> prioritaire</TextStyled> par rapport aux autres comportements
            auparavant prédominants chez une personne.{"\n\n"}Le désir de boire de l'alcool devient
            <TextStyled bold> impossible à maîtriser</TextStyled> et doit être assouvi au détriment
      ...
      <ElementDayDefi
        content={
          <TextStyled>
            Il n'y a <TextStyled bold> pas de consommation d'alcool sans risque,</TextStyled> mais
            des consommations à risque plus ou moins élevé (en fonction de la quantité et de la
            fréquence)
          </TextStyled>
        }
      />
      ...
      <ElementDayDefi
        content={
          <TextStyled>
            ...
            totale d'alcool bue à chaque occasion, {"\n    • "}de boire lentement, en mangeant et en
            alternant avec de l'eau, {"\n    • "}
            d'éviter les lieux et les activités à risque de consommation excessive d'alcool,{" "}
            {"\n    • "}de s'assurer d'être entouré de personnes de confiance et de pouvoir rentrer
            chez soi en toute sécurité après avoir consommé de l'alcool.
          </TextStyled>
        }
      />
      <ElementDayDefi
        content={
          <TextStyled>
            ...
            la durée de la grossesse et de l'allaitement de l'enfant, {"\n    • "}pendant l'enfance,
            l'adolescence et toute la période de la croissance, {"\n    • "}en cas de conduite
