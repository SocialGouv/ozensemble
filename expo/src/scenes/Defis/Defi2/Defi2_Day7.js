...
const Defi2_Day7 = ({ navigation, route }) => {
  ...
  return (
    <WrapperContainer title="Bilan de la semaine" onPressBackButton={navigation.goBack}>
      ...
      <P>
        Si vous êtes parvenu à <P bold>gérer la situation</P> dans le cadre de cette activité, vous
        êtes <P bold>capable de trouver seul(e) des solutions pour faire autrement.</P>
        {"\n\n"}
        <P bold>Sinon, vous avez pu mieux identifier quels sont vos points de blocage.</P>
        {"\n\n"}A tout moment: contactez nos équipes pour recourir à une aide complémentaire,
        gratuite et anonyme.
      </P>
      <ButtonsContainer>
        <ButtonPrimary
      ...
      <P bold>
        Vous n'êtes pas la seule personne à ressentir ces émotions qui impactent sur l'envie de
        boire !
      </P>
      <Spacer />
      <P>
        Chacun réagit différemment à l'alcool. Et les émotions peuvent aussi bien être positives que
        négatives.
      </P>
      <Spacer />
      <P>
        L'enquête du <P bold>British Medical Journal Open</P> montre que les émotions perçues
      ...
      <BackgroundEFEFEF>
        ...
        <Spacer />
        <P>
          L'<P bold>intensité des émotions augmente avec la vitesse et la quantité consommée</P>, et
          plus particuliérement pour l'agressivité.
        </P>
        <Spacer />
        <P>
          Bien évidemment, ces émotions peuvent être affectées par l'humeur du consommateur avant le
          premier verre.
        </P>
      </BackgroundEFEFEF>
      <P>
        Comme les deux faces d'une même pièce, l'alcool comporte des plaisirs mais aussi des effets
        négatifs. Alors quand vous choisissez de consommer :
        <P bold>
          {"\n    • "}identifiez votre état émotionnel avant le premier verre,{"\n    • "}{" "}
          choisissez le type de boisson,
      ...
      <Sources>
        <>
          ...
          <TextStyled>
            {"\n    • "}Le site Améli “L'alcool: définition et repères de consommation”
          </TextStyled>
          <LinkContainer
            onPress={() => {
              Linking.openURL(
