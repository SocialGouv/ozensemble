...
const Defi5_Day1_Navigator = ({ route }) => {
  return (
    <Defi5_Day1_Stack.Navigator
      ...
      initialRouteName="DEFI5_DAY1_ONBAORDING">
      ...
      />
      <Defi5_Day1_Stack.Screen
        name="DEFI5_DAY1_QUIZZ"
        component={Defi5_Day1_Quizz}
        initialParams={route.params}
      />
  ...
  return (
    <WrapperContainer
      ...
      <Element
        content={
          <>
            ...
            <TextStyled bold> questionnaire sur votre consommation de l'activité 1</TextStyled>,
            puis de comparer vos réponses avec celles que vous aviez données il y a de cela 4
            semaines. {"\n\n"}Ne vous laissez pas influencer par vos résultats précédents et
      ...
      <ButtonPrimaryStyled
        ...
        onPress={() => navigation.navigate("DEFI5_DAY1_QUIZZ")}
      />
    </WrapperContainer>
  );
};
...
export const ReevaluateConsoResult = ({ onlyScore = false, noShadow = false }) => {
        ...
        {!onlyScore && (
          <>
            <Element
              content={
                <>
                  Vous avez du mal à contrôler votre comportement{"\u00A0"}? Votre situation
                  est-elle plus compliquée que prévue{"\u00A0"}?{"\n\n"}
                  <TextStyled bold>
                    Votre résultat au test AUDIT est en hausse, ce qui peut indiquer que vous n'avez
                    pas reçu une aide adéquate de votre entourage ou de professionnels.
                  </TextStyled>
                  {"\n\n"}
                  N'attendez pas que votre situation et votre santé se détériore avant d'obtenir
                  l'aide dont vous avez besoin pour commencer à reprendre la maîtrise de vos
                  consommations.
                </>
              }
            />
  ...
  if (reevaluateScore < evaluateScore) {
    return (
      <>
        {!onlyScore && (
          <ScoreTitle color="#4030a5">Votre score est en baisse{"\u00A0"}!</ScoreTitle>
        )}
        ...
        {!onlyScore && (
          <>
            <Element
              content={
                <>
                  Votre consommation vous paraissait problématique{"\u00A0"}? Vous aviez le
                  sentiment qu'il fallait agir pour changer vos habitudes{"\u00A0"}?{"\n\n"}
                  <TextStyled bold>
                    Votre résultat au test AUDIT est en baisse, ce qui indique que la quantité
                    d'alcool que vous consommez semble avoir diminué.
                  </TextStyled>
                  {"\n\n"}
                  C'est une bonne étape dans votre parcours de réduction{"\u00A0"}! Poursuivez vos
                  efforts jusqu'à atteindre les{" "}
                  <TextStyled
                    underline
  ...
  return (
    <>
      {!onlyScore && (
        <ScoreTitle color="#4030a5">Votre score est en identique{"\u00A0"}!</ScoreTitle>
      )}
      <ScoresCompare noShadow={noShadow} onlyScore={onlyScore}>
      ...
      {!onlyScore && (
        <>
          <Element
            content={
              <>
                Votre nouvelle manière de consommer est-elle adéquate{"\u00A0"}? Pourquoi est-il
                important pour votre santé de boire avec modération{"\u00A0"}?{"\n\n"}
                <TextStyled bold>
                  Votre résultat au test AUDIT est inchangé, ce qui indique que la quantité d'alcool
                  que vous consommez semble être la même qu'auparavant.
                </TextStyled>
                {"\n\n"}
                Nous aborderons d'autres éléments de votre parcours durant ce bilan, toutefois,
                soyez vigilant à obtenir l'aide dont vous avez besoin pour atteindre votre objectif
                de réduction.
              </>
            }
          />
...
const ArrowDown = () => (
  <ArrowStyled
    ...
    <Path
      d="M41.986 41.25 22.5 75 3.014 41.25h38.972Z"
      fill="#28A745"
      stroke="#fff"
      strokeWidth={3}
    />
...
const ArrowUp = () => (
  <ArrowStyled
    ...
    <Path
      d="M41.986 36.75 22.5 3 3.014 36.75h38.972Z"
      fill="#EE7738"
      stroke="#fff"
      strokeWidth={3}
    />
