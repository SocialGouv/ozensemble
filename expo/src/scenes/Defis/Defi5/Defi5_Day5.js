...
export const answersDefi5Day5 = [
  {
    answerKey: "1.1",
    content: "Je suis satisfait(e) de ma progression et je n'ai aucune hésitation à continuer.",
  },
  { answerKey: "1.2", content: "J'ai fait des progrès mais c'est plus difficile que prévu." },
  {
    answerKey: "1.3",
    content: "J'ai envie de tout lâcher car je n'avance pas comme je l'avais espéré.",
  },
];
          ...
          <WrapperContainer
            ...
            <Paragraph>
              <P>
                ...
                <P bold>
                  {" "}
                  ma principale conclusion par rapport à l'évolution de ma situation{"\u00A0"}?
                </P>
              </P>
            </Paragraph>
            <CheckBoxes>
            ...
            <ButtonsContainer>
              <ButtonPrimary
                ...
                content="Je valide"
                disabled={!defi5_Day5_Answers?.length}
              />
            </ButtonsContainer>
          </WrapperContainer>
        )}
              ...
              {!!["1.1", "1.2"].includes(defi5_Day5_Answers) && (
                <>
                  ...
                  <Element
                    ...
                    content={
                      <TextStyled bold>
                        Félicitations{"\u00A0"}!{"\n"}Vous progressez vers la réussite de votre
                        objectif.
                      </TextStyled>
                    }
                  />
                  ...
                  <Element
                    ...
                    content={
                      <>
                        ...
                        {"\n\n"}
                        Il pourra envisager avec vous d'autres solutions et vous proposer une
                        orientation plus adaptée en télé-consultation, en présentiel ou en groupe.
                        {"\n\n"}
                        Vous pourrez aussi reprendre ce parcours à un autre moment ou essayer un
                        autre programme de réduction de consommation.
                      </>
                    }
                  />
                </>
