        ...
        {({ navigation }) => (
          <WrapperContainer
            ...
            <Element
              content={
                <>
                  ...
                  <TextStyled bold>
                    l'arrêt de l'alcool a de nombreux bienfaits pour la santé physique.
                  </TextStyled>{" "}
                  La consommation excessive d'alcool entraîne des problèmes de santé pouvant avoir
                  de graves conséquences.
                  {"\n\n"}
                  Que l'on cherche à améliorer son hygiène de vie, sa forme physique ou bien à
                  sortir de sa dépendance, le sevrage de l'alcool a des effets bénéfiques sur la
                  durée.
                </>
              }
            />
            <Element
              content={
                <>
                  Nous vous proposons maintenant de déterminer à l'aide d'un questionnaire les
                  effets physiques positifs que vous avez pu constater suite à la diminution de
          ...
          <WrapperContainer onPressBackButton={navigation.goBack} title="Mes bénéfices physiques">
            <Paragraph>
              <P>
                Voici une liste des{" "}
                <TextStyled bold>
                  changements que vous pouvez constater après ces 4 semaines de réduction
                </TextStyled>{" "}
              ...
              <>
                <Element
                  content={
                    <>
                      <TextStyled bold>
                        Ce sont des premiers signes encourageants !{"\n\n"}Maintenez vos efforts car
                        ces bénéfices vont se maintenir et s'amplifier dans le temps.
                      </TextStyled>{" "}
                      Les études scientifiques montrent des bénéfices à réduire sa consommation à
                      court terme, mais aussi à moyen terme et à long terme.
                    </>
                  }
                />
              </>
            ...
            {!!aucune(defi5_Day4_Answers) && (
              <>
                <Element
                  content={
                    <>
                      Si vous ne vous sentez pas en meilleure forme, cela peut être dû
                      principalement <TextStyled bold>à deux facteurs</TextStyled>
                      {"\u00A0"}:{"\n\n"}
                      {"   • "}{" "}
                      <TextStyled bold>
                        Votre réduction est encore récente ou trop modeste par rapport aux besoins
                        de votre corps.
                      </TextStyled>{" "}
                      Poursuivez ce bilan pour voir si d'autres domaines se sont améliorés depuis le
                      début de votre réduction ou vos progrès sont trop faibles.{"\n\n"}
                      {"   • "} C'est un signal de votre corps. Sachez l'écouter. Il est peut-être
                      temps d'utiliser cette information pour{" "}
                      <TextStyled bold>
                        vous orienter vers un bilan auprès d'un médecin{"\u00A0"}?
                      </TextStyled>
                      {"\n"}
                    </>
                  }
