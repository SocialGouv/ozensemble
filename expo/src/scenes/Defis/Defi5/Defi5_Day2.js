...
const interieurAndExterieur = (answers) =>
  (answers.includes("1.1") || answers.includes("1.2")) &&
  (answers.includes("1.3") || answers.includes("1.4"));

const interieurOnly = (answers) =>
  (answers.includes("1.1") || answers.includes("1.2")) &&
  !answers.includes("1.3") &&
  !answers.includes("1.4");

const exterieurOnly = (answers) =>
  !answers.includes("1.1") &&
  !answers.includes("1.2") &&
  (answers.includes("1.3") || answers.includes("1.4"));
        ...
        {({ navigation }) => (
          <WrapperContainer
            ...
            <Element
              content={
                <>
                  Vous aviez identifié des <TextStyled bold>situations à risque</TextStyled> lors de
                  votre semaine de
                  <TextStyled bold> l'activité 2</TextStyled>. Vous aviez sélectionné les 2
                  situations à risque
                  <TextStyled bold> extérieures</TextStyled> et les 2 situations à risque
                  <TextStyled bold> intérieures</TextStyled> pour vous.{"\n\n"}Souvenons-nous qu'une
                  situation à risque est un moment dans lequel une personne à l'impression qu'elle a{" "}
                  <TextStyled bold>
                    {" "}
                    moins de contrôle sur son envie de boire de l'alcool.
                  </TextStyled>
                </>
              }
            />
            <Element
              content={
                <>
                  Nous vous proposons maintenant d'évaluer vos progrès dans la gestion de vos
                  situations à risque à travers un questionnaire.
                </>
              }
            />
            <ButtonsContainer>
      ...
      <QuestionnaireDefi5Day2Stack.Screen name="DEFI5_DAY2_QUIZZ_QUESTIONS">
        {({ navigation }) => (
          <WrapperContainer
            ...
            <Paragraph>
              <P>
                Veuillez sélectionner parmi vos situations à risque celles que vous avez la
                perception de{" "}
                ...
                <Element
                  content={
                    <>
                      ...
                      <TextStyled bold>
                        {" "}
                        vous avez pris conscience des causes extérieures pouvant contribuer à votre
                        consommation d'alcool.
                      </TextStyled>
                      {"\n\n"}Vous avez davantage de chances de réfléchir de manière critique à
                      votre décision de consommer désormais.
                    </>
                  }
                />
                <Element
                  content={
                    <>
                      ...
                      {"\n\n"}Il est très important d'être attentif au fait que votre état intérieur
                      peut entraîner des envies de consommer de l'alcool. C'est en traitant ces
                      tensions internes que vous aurez la possibilité de réduire votre consommation.
                    </>
                  }
                />
              </>
                ...
                <Element
                  content={
                    <>
                      ...
                      <TextStyled bold>
                        {" "}
                        vous avez pris conscience des causes intérieures pouvant contribuer à votre
                        consommation d'alcool.
                      </TextStyled>
                      {"\n\n"}Il est très important d'être attentif au fait que votre état intérieur
                      peut entraîner des envies de consommer de l'alcool. C'est en traitant ces
            ...
            {!!aucune(defi5_Day2_Answers) && (
              <>
                <Element
                  content={
                    <>
                      <TextStyled bold>Ne culpabilisez pas</TextStyled> si vous n'arrivez pas à
                      mieux contrôler vos envies dans les situations que vous avez choisies.{"\n\n"}
                      L'autocontrôle reste difficile. Il est peut-être temps de questionner votre{" "}
                      <TextStyled bold> besoin d'aide par rapport à l'alcool.</TextStyled>
                      {"\n\n"}
                      {"   • "} Ce mode de consommation, est-il pour vous une façon de décompresser
                      {"\u00A0"}? D'évacuer un trop plein de stress{"\u00A0"}?{"\n"}
                      {"   • "} Buvez-vous pour vous mettre à l'aise en société{"\u00A0"}? En soirée
                      {"\u00A0"}?{"\n"}
                      {"   • "} Avez-vous le sentiment que l'alcool devient un remède aux
