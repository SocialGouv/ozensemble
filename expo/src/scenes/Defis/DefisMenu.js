  ...
  useEffect(() => {
    if (isFocused) {
      ...
      const lastfinishedDefiIndex =
        defiDays.findLastIndex((days) => days === 7) !== -1
          ? defiDays.findLastIndex((days) => days === 7)
          : 0;
    ...
    <WrapperContainer
      ...
      <View className="mb-4">
        <TextStyled lineHeight={18}>
          Chaque activité dure 7 jours et est composée de tests, de quiz et de lectures qui vous
          aideront à diminuer votre consommation et à accroitre votre motivation{"\u00A0"}!
        </TextStyled>
      </View>
      <CategorieMenu
