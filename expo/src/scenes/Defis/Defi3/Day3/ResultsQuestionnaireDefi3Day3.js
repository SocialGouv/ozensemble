    ...
    <Wrapper wrapped={wrapped} inMyTests={inMyTests}>
      <ContainerSection>
        ...
        {!defi3_Day3_Answers_Difficulties.length && (
          <TextStyled>
            Vous n'avez pas encore sélectionné de facteurs de difficultés, vous pouvez revenir à ce
                ...
                content={
                  <>
                    <TextStyled>
                      ...
                      <TextStyled bold>
                        recherche du plaisir et de situations conviviales
                      </TextStyled>
                      , comme boire pour passer une meilleure soirée. {"\n\n"}
                      Vous associez la consommation d’alcool à un{" "}
                      <TextStyled bold>état d’esprit positif</TextStyled> couplé à des{" "}
                      <TextStyled bold>situations extérieures</TextStyled> à votre personne : vous
                      avez du mal à “<TextStyled italic>fêter sans consommer</TextStyled>”.
                      {"\n\n"}
                      Ex : “<TextStyled italic>j’ai bu car cela m’amuse</TextStyled>”, car “
                      <TextStyled italic>j’aime la sensation que cela me procure</TextStyled>” ou
                      car “
            ...
            <ToggleContent title="Motif récréatif">
              <Element
                content={
                  <>
                    <TextStyled>
                      Votre raison de consommer serait plutôt la recherche de sensations fortes
                      d’amusement, de{" "}
                      <TextStyled bold>ressentir les effets positifs de l’alcool</TextStyled>.{" "}
                      {"\n\n"}
                      Vous associez donc la consommation d’alcool à un{" "}
                      <TextStyled bold>plaisir gustatif ou à l’ivresse</TextStyled> procurée et à
                      une <TextStyled bold>sensation de lâcher prise</TextStyled>. {"\n\n"}
                ...
                content={
                  <>
                    <TextStyled>
                      ...
                      Vous associez la comsommation d’alcool au fait d’
                      <TextStyled bold>aller moins mal</TextStyled> et de{" "}
                      <TextStyled bold>mieux gérer vos sentiments négatifs</TextStyled>. {"\n\n"}
                      Ex : “
                      <TextStyled italic>
                        je bois car cela m’aide quand je suis je suis nerveux ou déprimé
                      </TextStyled>
                ...
                content={
                  <>
                    <TextStyled>
                      ...
                      Vous pouvez avoir <TextStyled bold>du mal à refuser un verre</TextStyled> qui
                      vous est proposé par quelqu’un lors d’un moment convivial. {"\n\n"}
                      Ex : “<TextStyled italic>je bois pour faire partie d’un groupe</TextStyled>”
                      ou “<TextStyled italic>pour être apprécié(e)</TextStyled>”.
                    </TextStyled>
                  </>
                }
              />
      ...
      <ContainerSection>
        <ResultTitleContainer>
          <SmileyGreen />
          <ResultTitle color="#20B55C">
            Motifs d’aide à maintenir dans le temps mon objectif de réduction.
          </ResultTitle>
        </ResultTitleContainer>

        {!defi3_Day3_Answers_Help.length && (
          <TextStyled>
            Vous n'avez pas encore sélectionné de facteurs d'aide, vous pouvez revenir à ce
            questionnaire en allant dans la rubrique <TextStyled bold>Mes tests</TextStyled>{" "}
            dynamiques
            <TextStyled bold> Activités</TextStyled>.
          </TextStyled>
            ...
            <ToggleContent title="Motif psychologique">
              <Element
                content={
                  <>
                    <TextStyled>
                      Vous savez porter une attention particulière à votre “
                      <TextStyled italic>insight</TextStyled>”, processus par lequel un sujet se
                      saisit d'un aspect de sa propre dynamique psychique jusque-là méconnu de lui.{" "}
                      {"\n\n"}
                      Vous savez{" "}
                      <TextStyled bold>ne pas utiliser l’alcool pour gérer vos émotions</TextStyled>
                      , c'est pourtant un piège récurrent dans lequel il peut être facile de tomber.{" "}
                      {"\n\n"}
                      <TextStyled bold>
                        L’alcool ne doit pas être un consolant lorsqu’on ressent une émotion
                        négative, par exemple lorsqu’on est triste, anxieux ou stressé.
                      </TextStyled>
                    </TextStyled>
                  </>
                }
                ...
                content={
                  <>
                    <TextStyled>
                      ...
                      <TextStyled bold>
                        vous vous appuyez sur votre entourage pour trouver de la motivation
                      </TextStyled>
                      ...
                      {"\n\n"}
                      Ces groupes fonctionnent sur la base de réunions régulières. Ils permettent
                      aux personnes souffrant de d’
                      <TextStyled bold>addiction à l’alcool</TextStyled> d’en rencontrer d’autres
                      pour rompre l’isolement, partager leur expérience de l’alcool, obtenir des
                      conseils utiles et recréer des liens sociaux indispensables pour faire évoluer
            ...
            <ToggleContent title="Motif biologique">
              <Element
                content={
                  <>
                    <TextStyled>
                      Vous êtes attentif à votre santé : quelque soit votre situation et votre
                      consommation, un médecin vous recommandera toujours de diminuer votre
                      consommation. {"\n\n"}
                      Les motivations peuvent être variables d’une personne à l’autre, mais vous
                      trouverez forcément un bénéfice sur votre corps à plus ou moins long terme
                      comme retrouver{" "}
                      <TextStyled bold>
                        des cycles de sommeil plus réparateurs, une humeur plus stable au quotidien,
                        une meilleure fonction du foie, une meilleure capacité de concentration ou
                        encore une espérance de vie rallongée.
                      </TextStyled>
                    </TextStyled>
                  </>
                }
      ...
      <TextStyled>
        ...
        <TextStyled bold>Mes tests</TextStyled> dans <TextStyled bold>Activités</TextStyled>.
      </TextStyled>
      <ButtonPrimaryStyled
