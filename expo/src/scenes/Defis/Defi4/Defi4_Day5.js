    ...
    <QuestionnaireDefi4Day5Stack.Navigator
      ...
      <QuestionnaireDefi4Day5Stack.Screen name="EXPLICATIONS">
        {({ navigation }) => (
          <WrapperContainer
            ...
            title="Comment atteindre mon objectif ?">
            <Element
              content={
                <>
                  Le meilleur moyen de diminuer l’alcool est de{" "}
                  <TextStyled bold>vous faire plaisir autrement</TextStyled> ! Nous vous suggérons
                  de faire appel à votre imagination et, pourquoi pas à votre folie, pour dresser
                  une liste de choses qui vous font plaisir.
                </>
              }
            />
            <Element
              content={
                <>
                  ...
                  {"\n"}
                  Le pire moment à passer est <TextStyled bold>la fin de semaine</TextStyled> pour
                  la plupart des gens qui désirent modifier leurs habitudes de consommation. Quand
                  la fin de semaine arrive, vous pouvez avoir l’impression de devoir vous priver
                  d’une récompense et de ne pas pouvoir décompresser. Nous vous suggérons donc de
                  changer votre système de récompenses en développant de{" "}
            ...
            <Element
              content={
                <>
                  <TextStyled bold>
                    Les plaisirs planifiés sont souvent les plus satisfaisants parce qu’ils
                    demandent une préparation
                  </TextStyled>{" "}
                  et une attente plus longue avant de pouvoir en profiter comme par exemple quand on
                  fait un voyage, qu’on reçoit des amis à dîner ou que l’on va voir un spectacle.
                  Ayez du plaisir à prévoir le plaisir en évitant l’attitude « tout ou rien ». Pas
                  besoin de gagner à la loterie pour avoir du plaisir.{" "}
                  <TextStyled bold>
            ...
            <Element
              content={
                <>
                  Nous vous proposons maintenant de déterminer quelles activités pourraient vous
                  procurer du plaisir à travers un questionnaire.
                </>
              }
            />
            <ButtonsContainer>
              <ButtonPrimary
                onPress={() => navigation.push("QUIZZ_QUESTIONS")}
      ...
      <QuestionnaireDefi4Day5Stack.Screen name="QUIZZ_QUESTIONS">
        {({ navigation }) => (
          <WrapperContainer
            onPressBackButton={navigation.goBack}
            title="Je me fais plaisir autrement">
            <Paragraph>
              <TextStyled>
                Parmi ces exemples, quelles activités vous permettraient de vous faire plaisir
                autrement ? {"\n"}
