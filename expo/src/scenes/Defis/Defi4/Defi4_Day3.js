  ...
  return (
    <WrapperContainer onPressBackButton={navigation.goBack} title="Quels bénéfices à changer ?">
      <Element
        content={
          <>
            Nous avons abordé jusqu’à présent la fonction que l’alcool peut remplir pour vous. Il
            est également souhaitable de penser aux{" "}
            <TextStyled bold>
      ...
      <Element
        content={
          <>
            Vous trouverez ci-dessous quelques exemples de raisons de contrôler sa consommation
            d’alcool.
          </>
        }
      />
      ...
      <WhiteBackground>
        <KeyContainer>
          ...
          <TextContainer>
            ...
            <P>
              ...
              Voici l’un des slogans les plus connus des campagnes de lutte contre l’alcool au
              volant. Et pour cause, selon la sécurité routière, l’alcool cause{" "}
              <TextStyled bold>un tiers des accidents mortels</TextStyled>.
            </P>
          </TextContainer>
        </KeyContainer>
        <KeyContainer>
          ...
          <TextContainer>
            ...
            <P>
              En Europe, l’alcool est responsable de plus de 7% des maladies et décès prématurés. En
              France, il est à l’origine de <TextStyled bold>49 000 décès par an</TextStyled>. Sept
              cancers ont un lien avéré avec l’alcool.
            </P>
          </TextContainer>
        </KeyContainer>
        <KeyContainer>
          ...
          <TextContainer>
            ...
            <P>
              L’alcool engendre rapidement des signes visibles au niveau de la peau et en
              particulier du visage : cernes, lèvres gonflées, teint chiffonné et rouge, visage
              bouffi. Ces signes <TextStyled bold>s’atténuent en moins de deux semaines</TextStyled>{" "}
              en cas de réduction de la consommation d’alcool.
            </P>
          </TextContainer>
        </KeyContainer>
        <KeyContainer>
          ...
          <TextContainer>
            ...
            <P>
              L'alcool fait <TextStyled bold>grossir</TextStyled>. Il est non seulement
              inintéressant d'un point de vue nutritionnel mais il est en plus{" "}
              <TextStyled bold>calorique</TextStyled>. Un gramme d'alcool représente 7 kcal, soit
              107 kcal pour un verre de vin en moyenne.
            </P>
        ...
        <KeyContainer>
          ...
          <TextContainer>
            ...
            <P>
              Arrêter l’alcool est très bon pour la santé de votre corps mais aussi pour celle de
              votre porte-monnaie !
            </P>
      ...
      <ButtonPrimaryStyled
        content="J’ai trouvé mes raisons"
