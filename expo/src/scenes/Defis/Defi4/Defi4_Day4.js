          ...
          <WrapperContainer
            ...
            <PaddingContainer>
              <Element
                content={
                  <>
                    Il peut être plus stimulant de se fixer un objectif à{" "}
                    <TextStyled bold>court terme</TextStyled> plutôt qu’un objectif à{" "}
                    <TextStyled bold>long terme</TextStyled> d’emblée. En effet, il est plus
                    motivant d’atteindre plusieurs{" "}
                    <TextStyled bold>objectifs intermédiaires par paliers</TextStyled> que de se
                    fixer d’emblée la barre trop haut.
                  </>
                }
              />
            </PaddingContainer>
            <TimelineContainer>
              <TimelineImage
                source={require("../../../assets/illustrations/timelineDefi4Day4.png")}
              />
            </TimelineContainer>
            <PaddingContainer>
              <Element
                contentView={
                  <>
                    <P>
                      Un objectif réaliste est celui qui a de très bonnes chances d’être atteint.
                      Pour augmenter vos chances de succès, nous vous suggérons de vous fixer des{" "}
                      <TextStyled bold>
                    ...
                    <BulletPoint>
                      <P>
                        {"\u2022"} Si ils sont trop faciles, ils sont probablement trop bas et vous
                        pourrez avoir besoin de{" "}
                        <TextStyled bold>
                          plusieurs mois pour atteindre votre objectif final de réduction
                        </TextStyled>
                    ...
                    <BulletPoint>
                      <P>
                        {"\u2022"} Si ils sont trop difficiles, vous risquez de ne pas les atteindre
                        et de <TextStyled bold>diminuer votre confiance</TextStyled> en vos
                        capacités de réussir. De plus, réduire trop rapidement peut faire apparaître
                        des <TextStyled bold>symptômes de sevrage</TextStyled>.
                      </P>
                    </BulletPoint>
                  </>
                }
              ...
              <Element
                ...
                contentView={
                  <>
                    <P>
                      Pour <TextStyled bold>fixer votre objectif global</TextStyled> de façon
                      réaliste, nous vous suggérons :
                    </P>
                    <BulletPoint>
                      <P>
                        {"\u2022"} D’utiliser votre{" "}
                        <TextStyled bold>bilan de la première semaine</TextStyled> d'activité comme{" "}
                    ...
                    <BulletPoint>
                      <P>
                        {"\u2022"} De penser à{" "}
                        <TextStyled bold>un objectif de réduction qui vous motive</TextStyled> pour
                        des raisons personnelles ou de santé comme{" "}
                        <TextStyled bold>point d’arrivée</TextStyled>.
                      </P>
                    </BulletPoint>
                    <P>
                      Calculez ensuite la{" "}
                      <TextStyled bold>différence entre le nombre de consommations</TextStyled> de
                      votre point de départ et de votre point d’arrivée.{" "}
                    </P>
                    <P>
                      Enfin,{" "}
                      <TextStyled bold>étalez la différence de verres sur 8 semaines</TextStyled>.
                      Pour la plupart des gens, une période de 6 à 8 semaines constitue un délai
                      réaliste.{" "}
                    </P>
                  </>
                }
              ...
              <GreenBackground>
                <KeyContainer>
                  ...
                  <TextContainer>
                    <P>
                      Exemple : une personne consomme{" "}
                      <TextStyled bold>15 verres par semaine</TextStyled> et veut atteindre{" "}
                      <TextStyled bold>6 verres par semaine</TextStyled> pour protéger sa santé et
                      rejoindre les recommandations. Elle doit réduire de{" "}
                      <TextStyled bold>15 - 6 = 9 verres</TextStyled>. Elle étale sa réduction sur{" "}
                      <TextStyled bold>8 semaines</TextStyled> et doit donc réduire chaque semaine
                      de <TextStyled bold>9/8 = un peu plus d'1 verre</TextStyled>.
                    </P>
                  </TextContainer>
                </KeyContainer>
              </GreenBackground>
                ...
                <>
                  <Element
                    content={
                      <>
                        À la lumière de ces informations, vous pouvez maintenant{" "}
                        <TextStyled bold>mettre à jour votre objectif du mois prochain</TextStyled>{" "}
                  ...
                  <MyGoalSubContainer>
                    <MyGoalSubContainerInside>
                      ...
                      <PartContainer>
                        ...
                        <TextStyled>
                          {"  "}
                          {maxDrinksPerWeekGoal} {maxDrinksPerWeekGoal > 1 ? "verres" : "verre"} max
                          par semaine
                        </TextStyled>
                      </PartContainer>
                    </MyGoalSubContainerInside>
