  ...
  return (
    <NavigationWrapper
      ...
      <TopContainer>
        ...
        <P>
          <Bold>
            Les études montrent que l'alcool est une boisson très calorique et sa consommation peut
            provoquer une prise de poids.
          </Bold>
        </P>
        <P>
          De nombreuses études révèlent que l'alcool représente en moyenne entre 4 et 6% des apports
          énergétiques des régimes alimentaires occidentaux.
        </P>
        ...
        <Spacer size={20} />
        <P>
          L'alcool diminue l'élimination des graisses car les calories apportées par l'alcool sont
          brûlées très rapidement avant celles des graisses.{"\n"}La consommation d'alcool favorise
          ainsi l'accumulation des graisses, essentiellement au niveau abdominal, situation
          fréquente chez les grands consommateurs de bière.
        </P>
        <P bold>
          L'alcool stimule l'appétit en induisant une hypoglycémie: plus on boit d'alcool et plus on
          ressent des fringales !
        </P>
        <P>
          À titre indicatif, voici 4 équivalences alcool / nourriture pour mieux se rendre compte de
          la teneur en sucre des boissons alcoolisées :
        </P>
        <Correspondance
        ...
        <P>
          ...
          une unité d'alcool équivaut à 10 g d'alcool quelque soit le contenant.
        </P>
        <Table value={energetiquesValuesDrinks} firstWidth={50} />
        <Spacer size={20} />
        <P>
          <Bold>
            Ci-dessous, vous trouverez les 10 cocktails préférés des Français associés à leur
        ...
        <Spacer size={20} />
        <P>
          Et sinon… <Bold>l'eau est un bon substitut</Bold> car quand vous buvez 100 ml, 200 ml ou
          300 ml, vous absorbez <Bold>0 calorie !</Bold>
          {"\n"}L'eau est également une excellente manière d'<Bold>éviter la gueule de bois</Bold> à
          coup sûr.
        </P>
      </TopContainer>
    </NavigationWrapper>
    ...
    <TableContainer>
      <Tr backgroundColor={"#4030a5"}>
        {titles.map((title, index) => (
          <TdContainer
            key={index}
            width={index === 0 ? firstWidth : (100 - firstWidth) / (titles.length - 1)}>
