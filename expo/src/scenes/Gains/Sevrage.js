  ...
  return (
    <>
      ...
      <WrapperContainer title={"Les signes de sevrages"} onPressBackButton={navigation.goBack}>
        ...
        <DescriptionSymptome>
          Il s'agit de tremblements involontaires et incontrôlables en particulier des mains, mais
          aussi parfois de la tête et de la langue. Il peut aller de légers tremblements à une
          trémulation forte.
        </DescriptionSymptome>
        <Symptome>Sueurs</Symptome>
        <DescriptionSymptome>
          Elles apparaissent généralement sous 24h à 48h et se manifestent quelques heures après les
          dernières consommations.
        </DescriptionSymptome>
        <Symptome>Pouls accéléré</Symptome>
        <DescriptionSymptome>
          Normalement la fréquence cardiaque de l'adulte se situe en dessous de 80
          battements/minutes au repos.
        </DescriptionSymptome>
        ...
        <DescriptionSymptome>
          L'agitation est la manifestation physique et motrice, d'un état d'excitation interne.
          C'est donc bien une tension interne qui se manifeste par le corps.
        </DescriptionSymptome>
        <CTAButtonContainer>
          <ButtonPrimary
