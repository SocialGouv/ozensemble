...
const SigninScreen = ({ navigation }) => {
  ...
  return (
    <SafeAreaProvider className="flex-1 bg-[#3E309F]">
      <KeyboardAvoidingView
        behavior={Platform.select({ ios: "padding", android: null })}
        keyboardVerticalOffset={Platform.select({ ios: 0, android: 250 })}
      >
        <ScrollView keyboardShouldPersistTaps="never" keyboardDismissMode="none" className="flex bg-[#3E309F]">
          <View className=" px-5 justify-between space-y-8 mt-24">
