...
const ResultsOnboarding = ({ navigation, route }) => {
  ...
  return (
    <WrapperContainer
      onPressBackButton={() =>
        route?.params?.rootRoute === "HEALTH"
          ? navigation.navigate("ALCOHOL_ADDICTION")
          : navigation.goBack()
      }>
        ...
        <>
          ...
          <Sources>
            <TextStyled>
              ...
              Detection of Persons with Harmful Alcohol Consumption II. Addiction 1993 Jun ; 88(6) :
              791-804."
            </TextStyled>
          </Sources>
        </>
  ...
  return (
    <>
      ...
      <P>
        ...
        <Bold>suivre plus finement votre consommation d'alcool.</Bold>
      </P>
      <Spacer size={20} />
      <P>
        Si vous souhaitez en <Bold>apprendre plus sur une démarche de réduction,</Bold> faite la
        première activité.{" "}
      </P>
    </>
  );
  ...
  return (
    <>
      ...
      <P>
        Vous êtes{" "}
        <Bold>
          prêt(e) à entamer une démarche de maîtrise de votre consommation d'alcool en autonomie
        </Bold>
        , à travers une première activité pour faire le point en 7 jours.
      </P>
      <Spacer size={20} />
      <P>
        Vous découvrirez aussi de l'information fiable pour mieux appréhender les mécanismes
        d'addiction. Pour en savoir plus, consultez{" "}
        <TextStyled
          color="#4030a5"
          underline
      ...
      {feeling === true && (
        <>
          ...
          <P>
            ...
            <Bold> gratuitement sous 48H avec un professionnel formé en addictologie</Bold> pour
            vous aider dans votre parcours.
          </P>
          <TopButtonContainer>
            <ButtonPrimary
          ...
          <P>
            Nous vous proposons une démarche de maîtrise de votre consommation d'alcool en
            autonomie, <Bold>voici une première activité pour faire le point en 7 jours.</Bold>
          </P>
        </>
      )}
      {feeling === false && (
        <>
          ...
          <P>
            Vous êtes prêt à entamer une démarche de maîtrise de votre consommation d'alcool en
            autonomie, à travers <Bold>une première activité pour faire le point en 7 jours.</Bold>
          </P>
          <P>
            Vous découvrirez aussi de l'information fiable pour mieux appréhender les mécanismes
            d'addiction.
