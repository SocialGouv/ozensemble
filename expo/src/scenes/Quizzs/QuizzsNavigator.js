...
const QuizzMenu = () => {
  ...
  return (
    <WrapperContainer title="Tests des activités" onPressBackButton={navigation.goBack}>
      <SubTitle>
        Pour refaire les tests si besoin et continuer à réfléchir au rôle de l'alcool dans ma vie
        quotidienne.
      </SubTitle>
      <DefiCategorieTitle color="#4030a5">Activité 1</DefiCategorieTitle>
      <QuizzElement
        title="Mieux mesurer ma consommation"
        onStart={() =>
          navigation.navigate("EVALUATE_CONSO_QUIZZ", { initialRouteName: "QUIZZ_QUESTIONS" })
        }
        onShowResult={() =>
          navigation.navigate("EVALUATE_CONSO_QUIZZ", { initialRouteName: "QUIZZ_RESULTS" })
        }
      ...
      <QuizzElement
        ...
        onStart={() =>
          navigation.navigate("LIFE_QUALITY_QUIZZ", { initialRouteName: "QUIZZ_QUESTIONS" })
        }
        onShowResult={() =>
          navigation.navigate("LIFE_QUALITY_QUIZZ", { initialRouteName: "QUIZZ_RESULTS" })
        }
      ...
      <QuizzElement
        ...
        onStart={() =>
          navigation.navigate("MOTIVATIONS_QUIZZ", { initialRouteName: "QUIZZ_QUESTIONS" })
        }
        onShowResult={() =>
          navigation.navigate("MOTIVATIONS_QUIZZ", { initialRouteName: "QUIZZ_RESULTS" })
        }
        done={motivationsQuizzResult !== null}
        showOnlyIfDone
      />
      <DefiCategorieTitle color="#4030a5">Activité 2</DefiCategorieTitle>
      <QuizzElement
        title="Mes situations à risque"
        onStart={() =>
          navigation.navigate("RISK_SITUATIONS_QUIZZ", { screen: "QUIZZ_INTERNAL_SITUATIONS" })
        }
        onShowResult={() =>
          navigation.navigate("RISK_SITUATIONS_QUIZZ", { screen: "QUIZZ_RESULTS" })
        }
      ...
      <DefiCategorieTitle color="#4030a5">Activité 3</DefiCategorieTitle>
      <QuizzElement
      ...
      <QuizzElement
        ...
        showOnlyIfDone
      />
      <DefiCategorieTitle color="#4030a5">Activité 4</DefiCategorieTitle>
      <QuizzElement
        ...
        showOnlyIfDone
      />
      <DefiCategorieTitle color="#4030a5">Activité 5</DefiCategorieTitle>
      <QuizzElement
      ...
      <QuizzElement
        title="L'évolution de ma qualité de vie"
        onStart={() =>
          navigation.navigate("REEVALUATE_QUALITY_LIFE", { initialRouteName: "QUIZZ_QUESTIONS" })
        }
