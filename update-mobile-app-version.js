...
const projectPbxproj = fs.readFileSync('ios/oz_ensemble.xcodeproj/project.pbxproj', 'utf8');
...
fs.writeFileSync('ios/oz_ensemble.xcodeproj/project.pbxproj', newProjectPbxproj);
